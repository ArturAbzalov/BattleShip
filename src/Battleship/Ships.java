...
public enum Ships {
    ...
    public static void check4(Player player) {
        ...
        if (matcher.matches()) {
            ...
            if ((((ints[0] == ints[2]) && (ints[0] == ints[4]) && (ints[0] == ints[6])) ||
                    ((ints[1] == ints[3]) && (ints[1] == ints[5]) && (ints[1] == ints[7])))&&((((ints[7] - ints[5]) == 1) && ((ints[5] - ints[3]) == 1) && ((ints[3] - ints[1]) == 1)) ||
                    (((ints[6] - ints[4]) == 1) && ((ints[4] - ints[2]) == 1) && ((ints[2] - ints[0]) == 1)))&&((player.getBoard().getMap()[ints[0]][ints[1]]).equals(Ships.EMPTY) &&
    ...
    public static void check3(Player player) {
        ...
        if (matcher.matches()) {
            ...
            if ((((ints[0] == ints[2]) && (ints[0] == ints[4])) ||
                    ((ints[1] == ints[3]) && (ints[1] == ints[5])))&&(((((ints[5] - ints[3]) == 1) && ((ints[3] - ints[1]) == 1)) ||
                    (((ints[4] - ints[2]) == 1) && ((ints[2] - ints[0]) == 1))))&&((player.getBoard().getMap()[ints[0]][ints[1]]).equals(Ships.EMPTY) &&
                    (player.getBoard().getMap()[ints[2]][ints[3]]).equals(Ships.EMPTY) &&
                    (player.getBoard().getMap()[ints[4]][ints[5]]).equals(Ships.EMPTY))) {
                player.getBoard().setMap(ints);
            }else {
    ...
    public static void check2(Player player) {
        ...
        if (matcher.matches()) {
            int[] ints = Arrays.stream(string.split("[,;]+")).mapToInt(Integer::parseInt).toArray();
            if ((((ints[0] == ints[2])) ||
                    ((ints[1] == ints[3])))&&((((ints[3] - ints[1]) == 1)) ||
                    (((ints[2] - ints[0]) == 1)))&&((player.getBoard().getMap()[ints[0]][ints[1]]).equals(Ships.EMPTY) &&
                    (player.getBoard().getMap()[ints[2]][ints[3]]).equals(Ships.EMPTY))) {
                player.getBoard().setMap(ints);
            }
            else {
